  ...
  return (
    <Accordion multiple={true} defaultIndex={0} py={4}>
      ...
      <AccordionItem label="subfinder設定">
        <SubfinderSettings config={props.config} setConfig={props.setConfig} />
      </AccordionItem>
      ...
      <AccordionItem label="Web検索設定">
        <WebSearchSettings config={props.config} setConfig={props.setConfig} />
      </AccordionItem>
      <AccordionItem label="CVE検索設定">
        <CveSearchSettings config={props.config} setConfig={props.setConfig} />
      </AccordionItem>
    </Accordion>
  );
}
